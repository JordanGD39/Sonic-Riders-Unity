...
public class PipeMeshGenerator : MonoBehaviour
{
    ...
    public int startTriangleMaking = 0;
    public int endTriangleMaking = 8;
    ...
    public MeshRenderer CurrentMeshRender { get { return currentMeshRenderer; } }
    ...
    void MakeCylinderTriangles(List<int> triangles, int segmentIdx)
    {
        ...
        for (int i = startTriangleMaking; i < endTriangleMaking; i++)
        {
